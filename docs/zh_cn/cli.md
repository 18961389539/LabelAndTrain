...
X-AnyLabeling 提供命令行界面，用于启动图形界面、查询系统信息和转换标签格式。

> [!NOTE]
> 使用命令行前，请先按照[快速入门指南](./get_started.md)安装对应运行环境的依赖。
...
> 更多信息参见《用户手册》中的[标签导入导出](./user_guide.md#4-标签导入导出)。
