...
class QToaster(QtWidgets.QFrame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Follow the app theme instead of hard-coding a light box.
        try:
            from anylabeling.views.labeling.utils.theme import get_theme

            _t = get_theme()
            bg = _t.get("surface", "#FFFFFF")
            fg = _t.get("text", "#212121")
            border = _t.get("border", "#000000")
        except Exception:  # noqa: BLE001
            bg, fg, border = "#FFFFFF", "#212121", "#000000"
        ...
        self.corner = QtCore.Qt.Corner.BottomRightCorner
        self.margin = 10

    def set_label_color(self, color):
        """Recolor the message label (e.g. red for errors)."""
