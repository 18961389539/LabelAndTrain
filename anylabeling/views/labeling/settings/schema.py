...
def _non_shortcut_fields() -> list[SettingField]:
    return [
        ...
        SettingField(
            ...
            description=QT_TRANSLATE_NOOP(
                SETTINGS_TRANSLATION_CONTEXT,
                "Show a status mark in the file list (unannotated / annotated / checked). Enable this to also edit the annotation checkbox.",
            ),
        ),
        SettingField(
            "system_clipboard",
        ...
        SettingField(
            ...
            description=QT_TRANSLATE_NOOP(
                SETTINGS_TRANSLATION_CONTEXT,
                "Hold Alt while scrolling to adjust a selected rectangle; "
                "a plain wheel scrolls the viewport.",
            ),
        ),
        SettingField(
