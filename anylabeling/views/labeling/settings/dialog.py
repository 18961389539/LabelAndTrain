...
class SettingsDialog(QtWidgets.QDialog):
    ...
    def _build_palette(self) -> dict[str, tuple[int, int, int]]:
        """Delegates to settings.appearance."""
        return appearance.build_palette(self)

    def _rgb(self, key: str) -> str:
        """Delegates to settings.appearance."""
        return appearance.rgb(self, key)

    def _icon_pixmap(self, name: str, color: QtGui.QColor) -> QtGui.QPixmap:
        """Delegates to settings.appearance."""
        return appearance.icon_pixmap(self, name, color)

    def _brand_logo_pixmap(self) -> QtGui.QPixmap:
        """Delegates to settings.appearance."""
        return appearance.brand_logo_pixmap(self)

    def _combo_style(self) -> str:
        """Delegates to settings.appearance."""
        return appearance.combo_style(self)

    def _scrollbar_style(self) -> str:
        """Delegates to settings.appearance."""
        return appearance.scrollbar_style(self)

    def _radio_style(self) -> str:
        """Delegates to settings.appearance."""
        return appearance.radio_style(self)

    def _message_box_style(self) -> str:
        """Delegates to settings.appearance."""
        return appearance.message_box_style(self)
