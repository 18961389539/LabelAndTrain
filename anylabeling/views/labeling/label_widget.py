...
from .widgets import attributes_controller
...
class LabelingWidget(LabelDialog):
    ...
    def save_attributes(self, _shapes):
        """Delegates to attributes_controller (wiring and tests stay)."""
        return attributes_controller.save_attributes(self, _shapes)

    # React to canvas signals.
    def shape_selection_changed(self, selected_shapes):
        """Delegates to attributes_controller (wiring and tests stay)."""
        attributes_controller.shape_selection_changed(self, selected_shapes)
