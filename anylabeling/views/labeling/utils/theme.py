...
LIGHT: Dict[str, str] = {
    ...
    "surface": "#EFEEE9",
    "surface_hover": "#E5E4DE",
    "surface_pressed": "#DAD9D3",
    "border": "#E2E1DB",
    "border_light": "#CFCEC8",
    "text": "#1d1d1f",
    ...
    "highlight": "#14B8A6",
    "highlight_text": "#0D9488",
    "success": "#30D158",
    "warning": "#FF9F0A",
    "error": "#FF453A",
    "scrollbar": "#BFBEB8",
    "scrollbar_hover": "#A8A7A1",
    "selection": "#0D9488",
    "selection_text": "#ffffff",
    "tooltip_bg": "#1d1d1f",
    "tooltip_text": "#f5f5f7",
    "spinbox_button": "#EFEEE9",
    "spinbox_button_hover": "#E0DFD9",
    "button_bg": "#E3E2DC",
    "button_hover": "#D8D7D1",
    "button_pressed": "#CDCBC4",
}
...
DARK: Dict[str, str] = {
    ...
    "highlight": "#2DD4BF",
    "highlight_text": "#5EEAD4",
    "success": "#30D158",
    "warning": "#FF9F0A",
    "error": "#FF453A",
    "scrollbar": "#3C3C40",
    "scrollbar_hover": "#555559",
    "selection": "#14B8A6",
    "selection_text": "#ffffff",
    "tooltip_bg": "#232326",
    "tooltip_text": "#f5f5f7",
    "spinbox_button": "#303034",
    "spinbox_button_hover": "#3C3C40",
    "button_bg": "#2C2C30",
    "button_hover": "#36363A",
    "button_pressed": "#404045",
}
